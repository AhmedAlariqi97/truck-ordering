    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('discount-coupons.create') }}" class="btn btn-primary">New Discount Coupon</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
            ...
            <form action="" method="get">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{ route("discount-coupons.index") }}'" class="btn btn-default btn-sm">
                            Reset
                        </button>
                    </div>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('discount-coupons.edite', $discountCoupon->id) }}">
...
<script>
    function deleteDiscountCoupon(id) {
        ...
        var url = '{{ route("discount-coupons.delete", "ID") }}';
